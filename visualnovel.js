document.addEventListener("DOMContentLoaded", () => {
    ...
    if (bodyId === 'page4aactivity') {
        const cardsArray = [
            { name: 'A', img: 'cards/muichiro.jpg' },
            { name: 'B', img: 'cards/lumine.webp' },
            { name: 'C', img: 'cards/anya.jpg' },
            { name: 'D', img: 'cards/eren.jpg' },
            { name: 'E', img: 'cards/itadori.jpg' },
            { name: 'F', img: 'cards/mai.jpg' },
            { name: 'G', img: 'cards/maki.jpg' },
            { name: 'H', img: 'cards/mikey.jpg' },
            { name: 'I', img: 'cards/xielian.jpg' }, // New Card 1
        ];
