document.addEventListener("DOMContentLoaded", () => {
    const pageContent = {
        ...
        page4a: {
            steps: [
                ...
                {
                    text: "I'm just going to buy a Lumine file for Lumine. She likes to look a herself a lot.",
                    name: "Aether"
                },
                {
        ...
        page4b: {
            steps: [
                {
                    text: "Where is Ms Anya...",
                    img: "yorforger.png",
                    name: "Yor"
                },
                {
                    text: "If Ms Anya was here, she would love these plushies!",
                    img: "yorforger.png",
                    name: "Yor"
                },
                {
                ...
                {
                    text: "I'm trying to look for a plushie of Ms Anya- I mean my daughter!!",
                    img: "yorforger.png",
                    name: "Yor"
                },
                {
                    text: "You should get something that looks like that person!",
                    img: "yorforger.png",
                    name: "Yor"
                },
                {
    ...
    if (bodyId === 'page4bactivity') {
        const quizData = [
            ...
            {
                question: "Which of these two characters from Demon Slayer and Genshin Impact share the same English voice actor'?",
                choices: ["Nezuko & Lumine", "Tanjiro & Aether", "Zenitsu & Diluc", "Inosuke & Kaveh"],
                answer: "Tanjiro & Aether"
            },
            {
            ...
            {
                question: "In The Quintessential Quintuplets, who ends up becoming Fuutarou's wife?",
                choices: ["Miku", "Itsuki", "Nino", "Yotsuba"],
                answer: "Yotsuba"
            },
            {
                question: "In 'Demon Slayer', what is the name of Muichiro's brother?",
                choices: ["Shuichiro", "Toichiro", "Koichiro", "Yuichiro"],
                answer: "Yuichiro"
            },
            {
                question: "In Spy x Family, what is Anya's secret power?",
                choices: ["Teleportation", "Telepathy", "Object Manipulation", "Precognition"],
                answer: "Telepathy"
            }
        ];
